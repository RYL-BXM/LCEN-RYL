...
from clip.clip_text import class_names, new_class_names, BACKGROUND_CATEGORY#, imagenet_templates
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='D:/bxm/VOCdevkit/VOC2012/JPEGImages')
    parser.add_argument('--split_file', type=str, default='./datasets/voc/train.txt')
    parser.add_argument('--cam_out_dir', type=str, default='./final/ablation/voc_baseline')
    parser.add_argument('--model', type=str, default='E:/ryl/WeCLIP+3-coco/pretrained/ViT-B-16.pt')
