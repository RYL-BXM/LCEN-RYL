...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='D:/ToCo-main/datasets/coco/MSCOCO/JPEGImages/val')
    parser.add_argument('--split_file', type=str, default='F:/WeCLIP/datasets/coco/val.txt')
    ...
    train_list = [x[0] for x in file_list]
